...
import { CategoryProductsComponent } from '../home/components/category-products/category-products.component';

const routes=[
    {path:"home/categoryProducts/:catId",Component:CategoryProductsComponent}
]
@NgModule({
